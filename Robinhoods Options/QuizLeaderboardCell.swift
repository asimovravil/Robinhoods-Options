...
class QuizLeaderboardCell: UITableViewCell {
    ...
    static let id = String(describing: QuizLeaderboardCell.self)
    ...
    func configure(with playerName: String, score: Int) {
        nameWord.text = playerName
        amountWord.text = "\(score)"
    }
